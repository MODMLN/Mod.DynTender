...
function TenderItem(_a) {
    ...
    return (react_1["default"].createElement("div", { onClick: function (e) {
        ...
        react_1["default"].createElement(Box_1["default"], { className: Tender_module_scss_1["default"].BoxMain, key: index, sx: { p: 2, border: '1px solid grey' } },
            (function () {
                switch (item.Statuses) {
                    case 'Going':
                        return (react_1["default"].createElement(react_1["default"].Fragment, null,
                            react_1["default"].createElement(Box_1["default"], { className: Tender_module_scss_1["default"].BoxHead + " Active" },
                                ...
                                react_1["default"].createElement(Box_1["default"], null,
                                    "\u05DE\u05E1\u05F3: ",
                                    item.TenderNumber),
                                react_1["default"].createElement(Box_1["default"], { className: Tender_module_scss_1["default"].headText }, item.Name))));
                    case 'NotYetStarted':
                        return (react_1["default"].createElement(react_1["default"].Fragment, null,
                            react_1["default"].createElement(Box_1["default"], { className: Tender_module_scss_1["default"].BoxHead + " " + Tender_module_scss_1["default"].NotYetStarted },
                                react_1["default"].createElement(Box_1["default"], null),
                                react_1["default"].createElement(Box_1["default"], null,
                    ...
                    case 'Ended':
                        return (react_1["default"].createElement(react_1["default"].Fragment, null,
                            react_1["default"].createElement(Box_1["default"], { className: Tender_module_scss_1["default"].BoxHead + " " + Tender_module_scss_1["default"].Ended },
                                react_1["default"].createElement(Box_1["default"], null),
                                react_1["default"].createElement(Box_1["default"], null,
                    ...
                    case 'Paused':
                        return (react_1["default"].createElement(react_1["default"].Fragment, null,
                            react_1["default"].createElement(Box_1["default"], { className: Tender_module_scss_1["default"].BoxHead + " " + Tender_module_scss_1["default"].Paused },
                                react_1["default"].createElement(Box_1["default"], null),
                                react_1["default"].createElement(Box_1["default"], null,
            ...
            react_1["default"].createElement(Box_1["default"], { className: Tender_module_scss_1["default"].line }),
            (item.Statuses === "NotYetStarted" || item.Statuses === "Paused") ? (react_1["default"].createElement(react_1["default"].Fragment, null,
                react_1["default"].createElement(Box_1["default"], { style: { textAlign: "right" } },
                    ...
                    react_1["default"].createElement(Box_1["default"], { className: Tender_module_scss_1["default"].bold },
                ...
                react_1["default"].createElement(Box_1["default"], { className: Tender_module_scss_1["default"].line }))) : (react_1["default"].createElement(react_1["default"].Fragment, null,
                react_1["default"].createElement(Box_1["default"], { style: { height: "auto", clear: "both" } },
                    react_1["default"].createElement("span", null)))),
            react_1["default"].createElement(Box_1["default"], { className: Tender_module_scss_1["default"].Proposal },
                react_1["default"].createElement(Box_1["default"], { className: Tender_module_scss_1["default"].leadPrice },
                ...
                react_1["default"].createElement(Box_1["default"], { className: Tender_module_scss_1["default"].greenProposal },
